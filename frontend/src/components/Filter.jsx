                    ...
                    <div className="relative flex flex-row gap-2 flex-grow overflow-x-auto scrollbar-hidden" ref={scrollContainerRef}>
                        {filteredOptions.map(option => (
                            <button
                                ...
                                className={`flex-shrink-0 px-3 min-w-[100px] py-1 h-10 rounded-md text-sm whitespace-nowrap ${selectedFilters.includes(option) ? "bg-[#2FB574] text-white" : "bg-[#1A3A2C] text-gray-300"
                                    }`}
                            >
                                {option}
                            </button>
