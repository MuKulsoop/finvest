                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="space-y-4">
                                        <Input
                                            ...
                                            required
                                            className="w-full border-0 border-b border-gray-300 focus:ring-0 focus:outline-none"
                                        />
                                        <Textarea
                                            name="description"
                                        ...
                                        {/* <select
                                            ...
                                            onChange={handleChange}
                                            required
                                            className="w-full border-0 border-b border-gray-300 focus:ring-0 focus:outline-none text-gray-500 px-2 py-2"
                                        >
                                ...
                                <div className="flex-2 m ">
                                    <div className="bg-gray-100 rounded-[30px] p-6 space-y-4">
                                        ...
                                        <div className="relative mt-6">
                                            ...
                                            <div className="absolute left-2 top-0 bottom-0 w-2 bg-green-500 rounded-full transition-all duration-1000 ease-in-out" style={{ height: `${milestoneProgress.filter(Boolean).length / milestoneCount * 100}%` }}></div>

                                            <div className="space-y-4 pl-1">
                                                {formData.milestones.map((milestone, index) => (
                                                    <div key={index} className="flex items-center gap-2">
                                                        <div className={`h-4 w-4 z-[5] rounded-full ${milestoneProgress[index] ? 'bg-green-500' : 'bg-gray-300'}`} />
                                                        <Textarea
